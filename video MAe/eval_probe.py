...
Steps:
  1. Load encoder from checkpoint (decoder discarded).
  ...
  4. Linear probe: nn.Linear(192, 2) trained with AdamW + MSE on z-scored labels.
...
Usage:
  python eval_probe.py --checkpoint /scratch/sb10583/checkpoints/videomae-v1/best.pt
