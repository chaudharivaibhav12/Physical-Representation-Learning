"""
Linear probe + kNN evaluation for VICReg ViT encoder (vision-transformer-v1).
...
Usage:
    python eval_probe.py \
        --checkpoint /scratch/sb10583/checkpoints/vicreg-v2/best.pt \
        --data-dir   /scratch/sb10583/data/data \
        --output-json vicreg-v1_results.json
"""
...
def main():
    ...
    parser.add_argument("--output-json",   default="vicreg-v1_results.json", type=Path)
